...
export const projects: IProjects[] = [
  ...
  },
  {
    ...
    description:
      "Este projeto é um site que permite jogar joquempô utulizando as suas mãos (requer webcam). Ele detecta as posições de suas mãos e dedos e usa isso como entrada.",
